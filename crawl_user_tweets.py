...
def get_user_tweets(users, filename):
    ...
    users_out_file = open("usersList/"+filename, 'w')
...
def main():
    ...
    files_list = os.listdir("/home/amtibaa/Twitter_Crawler/usersList")
    for file in files_list:
        ...
        #while True:
           ...
           #     print "same day"
           #     break
        users = read_user_ids(file)
        user_tweets = []
        user_tweets = get_user_tweets(users, file)
        print "Finished...."
